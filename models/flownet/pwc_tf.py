...
class PWC_tf(nn.Module):
    ...
    def forward(self, feature_list_1, feature_list_2, img_hw):
        ...
        up_flow6 = F.interpolate(flow6, scale_factor=2.0, mode='bilinear', align_corners=False)*2.0
        ...
        up_flow5 = F.interpolate(flow5, scale_factor=2.0, mode='bilinear', align_corners=False)*2.0
        ...
        up_flow4 = F.interpolate(flow4, scale_factor=2.0, mode='bilinear', align_corners=False)*2.0
        ...
        up_flow3 = F.interpolate(flow3, scale_factor=2.0, mode='bilinear', align_corners=False)*2.0
        ...
        flow2 = F.interpolate(flow2 * 4.0, [img_h, img_w], mode='bilinear', align_corners=False)
        flow3 = F.interpolate(flow3 * 4.0, [img_h // 2, img_w // 2], mode='bilinear', align_corners=False)
        flow4 = F.interpolate(flow4 * 4.0, [img_h // 4, img_w // 4], mode='bilinear', align_corners=False)
        flow5 = F.interpolate(flow5 * 4.0, [img_h // 8, img_w // 8], mode='bilinear', align_corners=False)
